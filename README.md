...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/basedpyright-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/basedpyright-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add basedpyright
# for installing globally
pixi global install basedpyright
```
...
It is possible to list all of the versions of `basedpyright` available on your platform:
...
```
pixi search basedpyright --channel conda-forge
```
